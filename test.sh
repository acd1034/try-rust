...
assert 10 'int main() { return +10; }'
# relational
assert 1 'int main() { return 0<1 ? 1 : 0; }'
assert 0 'int main() { return 1<1 ? 1 : 0; }'
assert 0 'int main() { return 2<1 ? 1 : 0; }'
assert 1 'int main() { return 0<=1 ? 1 : 0; }'
assert 1 'int main() { return 1<=1 ? 1 : 0; }'
assert 0 'int main() { return 2<=1 ? 1 : 0; }'
assert 1 'int main() { return 1>0 ? 1 : 0; }'
assert 0 'int main() { return 1>1 ? 1 : 0; }'
assert 0 'int main() { return 1>2 ? 1 : 0; }'
assert 1 'int main() { return 1>=0 ? 1 : 0; }'
assert 1 'int main() { return 1>=1 ? 1 : 0; }'
assert 0 'int main() { return 1>=2 ? 1 : 0; }'
# equality
assert 0 'int main() { return 0==1 ? 1 : 0; }'
assert 1 'int main() { return 42==42 ? 1 : 0; }'
assert 1 'int main() { return 0!=1 ? 1 : 0; }'
assert 0 'int main() { return 42!=42 ? 1 : 0; }'
assert 1 'int main() { return (1==1)==(1==1) ? 1 : 0; }'
assert 1 'int main() { return (1==1)==1 ? 1 : 0; }'
# assign
...
assert_fail 'int main() { return 1 ? 1==1 : 0; }'
# practical
