...
# assert_fail 'int main() { a=1; b=2; a=&b; return a; }'
...
# assign
assert 42 'int main() { return foo123=42; }'
assert 42 'int main() { return _123=42; }'
assert 2 'int main() { return a=a=2; }'
assert 2 'int main() { return (x=1)=2; }'
assert_fail 'int main() { return 1=2; }'
assert_fail 'int main() { return a; }'
# statements
assert 3 'int main() { 1; 2; return 3; }'
assert 8 'int main() { a=3; b=5; return a+b; }'
assert 6 'int main() { a=3; b=a; return a+b; }'
assert 6 'int main() { a=b=3; return a+b; }'
assert 2 'int main() { x=1; x=2; return x; }'
...
# if
assert 1 'int main() { x=0; if (1) x=1; return x; }'
assert 1 'int main() { x=0; if (1) x=1; else x=2; return x; }'
...
# defunc
assert 6 'int sub() { return 4; } int main() { a=b=3; return a+b; }'
assert_fail 'int main() { return 4; } int main() { a=b=3; return a+b; }'
assert 0 'int sub(int a, int b, int c, int d, int e, int f) { return a+b+c+d+e+f; } int main() { return 0; }'
# funcall
assert 8 'int sub() { return 4; } int main() { a=b=sub(); return a+b; }'
assert_fail 'int main() { a=b=sub(); return a+b; }'
...
assert 0 'int sub(int a); int sub(int b) { return b; } int main() { return 0; }'
...
assert_fail 'int main() { x=3; &-x; return x; }'
assert_fail 'int main() { x=3; *x; return x; }'
assert_fail 'int main() { x=3; y=&x; z=&y; z=&x; return *z; }'
assert_fail 'int main() { x=3; y=&x; z=&y; z=&x; return **z; }'
